...
def train_fn(
    ...
    for batch_idx, (real, _) in enumerate(loop):
        ...
        # Train Critic: max E[critic(real)] - E[critic(fake)] <-> min -E[critic(real)] + E[critic(fake)] ------------> Watch Wassertain GAN video.
...
def main():
    ...
    critic = Discriminator(config.IN_CHANNELS, config.CHANNELS_IMG).to(config.DEVICE)
